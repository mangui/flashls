set FLEXPATH=C:\PATH_OF_YOUR_FLEX_SDK
...
@call "%FLEXPATH%\bin\mxmlc.bat" ..\src\org\mangui\chromeless\ChromelessPlayer.as ^
    -source-path ..\src ^
...
@call "%FLEXPATH%\bin\mxmlc.bat" ..\src\org\mangui\flowplayer\HLSPluginFactory.as ^
...
@call "%FLEXPATH%\bin\mxmlc.bat" ..\src\org\mangui\osmf\plugins\HLSDynamicPlugin.as ^
    -source-path ..\src ^
...
@call "%FLEXPATH%\bin\compc.bat" -include-sources ..\src\org\mangui\osmf ^
