...
package org.mangui.hls.utils
{
	 ...
	 * 
	 * This is an simplified, improved and generally more reliable version of 
	 * the WebVTT parser used by Denivip HLS plugin for OSMF
	 * 
	 * @author	Neil Rackett
	 */
	public class WebVTTParser
	{
		...
		static public function parse(data:String, offset:Number=0):Vector.<Subtitles>
		{
			...
			var lines:Array = data.replace(/\b\salign:\S+/ig,'').split(/(?:(?:\r\n|\r|\n){2,})/);
